...
#define STRING_CONFIG_H_AUTHOR "(ikarezic, sappireTFT35)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 456 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -35, 8.6, 0 }
